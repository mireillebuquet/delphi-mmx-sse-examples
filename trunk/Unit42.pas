...
{
  delphi + assembler - czarna strona dobrze opisane i tabele rejestrow i wywolania
  http://www.guidogybels.eu/asmstart.html

  Small assembly tutorial
  http://my.opera.com/duminicad/blog/2009/08/28/small-assembly-tutorial


  Asm code hooking
  http://tpforums.org/forum/thread-5069.html


  Delphi Assembler Function Conventions
  http://www.tek-tips.com/faqs.cfm?fid=7412


  http://stackoverflow.com/questions/3313447/delphi-assembly-function-returning-a-long-string
